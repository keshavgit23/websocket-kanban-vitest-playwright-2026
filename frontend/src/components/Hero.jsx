...
export default function Hero(){
    return (
        <section className="min-h-screen flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-8 gap-10">
            ...
            <div>
                <img src={kanban_board} alt="Kanban Board" className="w-full max-w-4xl rounded-xl shadow-2xl mt-6 md:mt-0"></img>
            </div>
        </section>
    )
}