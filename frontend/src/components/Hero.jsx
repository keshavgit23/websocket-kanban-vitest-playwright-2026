    ...
    return (
        <section className="flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-16 gap-10">
            ...
            <div className="mt-4 flex gap-8">
                <button className="text-xl text-black bg-teal-100 px-4 py-2 font-bold hover:bg-teal-600 hover:text-white rounded-lg">
                    Try Now
                </button>
            ...
            <div>
                <img src={kanban_board} alt="Kanban Board" className="w-full max-w-3xl rounded-xl shadow-2xl"></img>
            </div>
        </section>
    )
}