export default function Features() {
    return (
        <section className="flex flex-row md:flex-col items-start justify-between px-8 md:px-20 py-16 gap-10 bg-gray-50">
            <h2 className="text-4xl font-bold text-teal-500">Features</h2>

            <div className="grid md:grid-cols-3 gap-8"> {/*all cards */}
                <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition hover:shadow-teal-200"> {/*single card*/}
